...
import Delaunator from "./utils/delaunator.js";
import { randomInRange } from "./utils/Maf.js";
import { weld } from "./utils/geometry-index.js";
...
function generateFragments(VERTICES = 100, VERTICES_PER_CHUNK = 20) {
  ...
  for (const geo of geometries) {
    ...
    const piece = new THREE.Mesh(extrudedGeo, material);
